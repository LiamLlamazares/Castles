...
const PIECE_INFO: Record<PieceType, {
  ...
  [PieceType.Wizard]: { movement: '1 (any)', attackType: 'Ranged', range: 'exactly 2 hexes', heavy: false, flying: false, special: 'Fireball: deals 1 damage to target + neighbors. Teleport: move anywhere.' },
