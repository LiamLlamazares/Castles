...
export function createM2L5(): TutorialLesson {
  ...
  const pieces = [
    ...
    PieceFactory.create(PieceType.Swordsman, new Hex(1, -2, 1), "b"), // Target
  ];
  ...
  return {
    ...
    description: (
      <div>
        <p style={{ marginTop: 0 }}>
          The Knight is a mobile melee unit that can leap over other pieces.
        </p>
        <div style={{ marginTop: "12px" }}>
          ...
          <div style={{ marginBottom: "6px" }}>
            <strong>Movement:</strong> Any number of hexes diagonally.
          </div>
          <div style={{ marginBottom: "6px" }}>
    ...
    pieces,
    layout,
    objectives: ["Use the Knight to reach and capture the enemy"],
    hints: [],
    instructions: "Move next to the enemy and capture.",
  };
}
