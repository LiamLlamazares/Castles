...
Account v1 is intentionally narrow. It supports display-name account creation, bearer-token account sessions, current-account lookup, account-owned game history, active-game rejoin, and current-session revocation. It does not yet include passwords, email, profiles, ratings, roles, moderation, sign-out-all session management, or account deletion.
