...
- Add fair-play signals, adjudication policy, sanctions, and richer admin audit views on top of the first account-report submission route, People-panel report flow, protected report queue, status-transition audit foundation, and protected per-report audit-history readback.
...
2. Add remaining account lifecycle work before public launch: account-linked game-history retention is now explicit in deletion UI and contracts as of 2026-06-05; next tighten ratings and moderation contracts.
