...
5. UI/navigation/tutorial/save QA.
   ...
   - Next after Profile/Dashboard v1: first-run and tutorial-progress QA closure. Strengthen the existing first-run, tutorial overview, and tutorial lesson audit states so they verify the real `Start Tutorial`, `Set Up Game`, overview-return, lesson-progress, and next-lesson controls plus the visible progress-storage cues at desktop/mobile/short-mobile sizes. Keep the audit state isolated from the user's real local progress.
