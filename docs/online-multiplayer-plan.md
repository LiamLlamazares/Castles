...
- Pick the first non-Done slice from `Next Ordered Slices`; the next planned slice is item 5, UI/navigation/tutorial/save QA. Select a concrete item 5 sub-slice before implementation and record it here first.
