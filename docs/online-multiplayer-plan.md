...
2. Account/social privacy and moderation boundary pass.
   ...
   - Current item 2 notes: account challenge and account-history raw account id redaction is implemented with local verification passed, pending production deploy evidence. Continue the privacy pass with remaining trusted-error and response-shape checks before marking item 2 done.
