...
- Add fair-play signals, adjudication policy, sanctions, and richer admin audit views on top of the first account-report submission route, People-panel report flow, protected report queue, and status-transition audit foundation.
