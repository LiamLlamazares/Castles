...
- Pick the first non-Done slice from `Next Ordered Slices`; the next planned slice remains item 3, starting with broader notification-loop handling on top of the existing account challenge inbox/status surface.
