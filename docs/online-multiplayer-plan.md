...
- Pick the first non-Done slice from `Next Ordered Slices`; items 1 through 10 are closed in the clean continuation worktree, and the next active planned slice is item 11. Item 11 is currently in its required design/spec review gate, not runtime implementation.
