...
- Pick the first non-Done slice from `Next Ordered Slices`; the next planned slice remains item 3, auditing any remaining existing-notification-loop gaps beyond the current count-only navigation badge while keeping push/email notifications deferred.
