...
- Pick the first non-Done slice from `Next Ordered Slices`; the next planned slice remains item 3, auditing direct challenge-link action synchronization and any remaining existing-notification-loop gaps while keeping push/email notifications deferred.
