...
- Pick the first non-Done slice from `Next Ordered Slices`; item 5 is closed in the clean continuation worktree, and the active planned slice is item 6, ratings/moderation pre-public hardening.
