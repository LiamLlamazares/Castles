...
- Pick the first non-Done slice from `Next Ordered Slices`; the next planned slice remains item 3, continuing broader notification-loop handling beyond the existing-navigation count badge while keeping push/email notifications deferred.
