...
5. UI/navigation/tutorial/save QA.
   ...
   - Then: item 5 closure audit. Reconcile the first-run/tutorial, save modal, drawer, Lobby row, return-path, and long-status evidence above; either mark item 5 Done or record a concrete remaining defect before starting item 6.
