...
5. UI/navigation/tutorial/save QA.
   ...
   - Then: long online status/error QA closure. Add screenshot coverage for a deliberately long trusted online status/error message and its recovery action at desktop/mobile/short-mobile sizes; verify wrapping, reachability, and secret redaction.
